...
\begin{homeworkProblem}[: Procedimiento para crear un avión (2 puntos)]
...
\begin{homeworkProblem}[: Procedimientos de limpieza (1 punto)]
  ...
  \item Crea un procedimiento \texttt{BORRAR\_AVIONES} que borre todos los aviones (y posibles piezas
    sueltas) de la base de datos. También reiniciará (borrará y volverá a crear) todas las secuencias que se utilicen.
  \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\needspace{.15\textheight}
\begin{homeworkProblem}[: Funciones de comprobación (3 puntos)]
  \begin{itemize}
